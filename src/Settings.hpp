...
#define TIME_GPS_EPHEMERIDE_MAX 3600     // research ephemeride gps at the beginning of charging(seconds)
#define TIME_GPS_EPHEMERIDE_FIX 900      // fix duration to get ephemeride at the beginning of charging(seconds)
#define TIME_DIVE_EPHEMERIDES_FIX 300    // fix duration to get ephemeride at the end of a valid dive (seconds)
...
#define WAKE_UP_WATER_THRESHOLD 370
#define END_DIVE_WATER_THRESHOLD 370
