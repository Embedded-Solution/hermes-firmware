...
#define TIME_GPS_START 5               // research time gps at the beginning of the dive(seconds)
#define TIME_GPS_END 5                 // research time gps at the end of the dive (seconds)
...
#define TIME_CHECK_POWER 10 // Time between 2 battery ccheck during dynamic dive. (seconds)
